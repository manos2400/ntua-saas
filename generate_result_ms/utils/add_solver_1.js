...
// function insertSolverIntoDatabase (solverName, solverDescription, pythonFilePath)  {
...
//     db.serialize(() => {
//         db.run('CREATE TABLE IF NOT EXISTS Solver (solver_id INTEGER PRIMARY KEY, solver_name TEXT NOT NULL, solver_description TEXT, solver_blob_data BLOB)');
//         const stmt = db.prepare('INSERT INTO Solver (solver_name, solver_description, solver_blob_data) VALUES (?, ?, ?)');
